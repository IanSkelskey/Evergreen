...
* **Get connected**: See *Resources and Support → Community Support* for mailing lists, chat, and involvement links
* **Check existing work**: See *Using Launchpad → Bug Reports* for searching existing bugs before filing new reports
...
2. **Develop and commit**: Follow the guidance in *Commit Standards and Quality* for message format and required sign-offs.
...
# Add sign-offs when testing (see Commit Standards and Quality)
----
