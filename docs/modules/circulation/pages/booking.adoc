...
image::booking/booking-pull-list-options.png[Pull List options.]
...
image::booking/booking-pickup-1.png[Pick Up Reservations screen with patron barcode field.]

[start=3]
3. Select the reservation(s) to pick up and confirm.
4. The screen refreshes, displaying the updated reservation status.

image::booking/booking-pickup-2.png[Pick Up Reservations screen showing selected reservations.]
...
image::booking/booking-return-1.png[Return Reservations screen with barcode fields.]

[start=3]
3. Confirm the return in the pop-up window.
4. The screen updates to reflect returned items.

image::booking/booking-return-2.png[Return Reservations screen showing returned items.]
